...
final class CameraViewController2: BaseViewController {
...
//이미지 처리하는 부분
extension CameraViewController2: UINavigationControllerDelegate, UIImagePickerControllerDelegate, AVCapturePhotoCaptureDelegate {
