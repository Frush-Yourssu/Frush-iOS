//
//  KoreanMelonFirstStepViewController.swift
//  Frush
//
...
final class KoreanMelonFirstStepViewController: BaseViewController {
    ...
    private let firstStepView = KoreanMelonFirstStepView()
    ...
    override func configureSubviews() {
        ...
        firstStepView.tapCameraButton = { [weak self] in
            guard let self else { return }
            router.presentKoreanMelonCameraViewController()
        }
    }
